...
--
-- Host: localhost:3306
-- Generation Time: Apr 07, 2017 at 01:12 AM
...
(184, 'CPSC', 502.01, 'Research Project in Computer Science', 'Research Project in Computer Science'),
(185, 'CPSC', 502.02, 'Research Project in Theoretical Computer Science', 'Research Project in Theoretical Computer Science'),
(186, 'CPSC', 502.03, 'Research Project in Computer Graphics', 'Research Project in Computer Graphics'),
(187, 'CPSC', 502.04, 'Research Project in Information Security', 'Research Project in Information Security'),
(188, 'CPSC', 502.05, 'Research Project in Scientific Computation', 'Research Project in Scientific Computation'),
(189, 'CPSC', 502.06, 'Research Project in Software Engineering', 'Research Project in Software Engineering'),
(190, 'CPSC', 502.07, 'Research Project in Human Computer Interaction', 'Research Project in Human Computer Interaction'),
(191, 'CPSC', 503.01, 'Project in Computer Science', 'Project in Computer Science'),
(192, 'CPSC', 503.02, 'Project in Theoretical Computer Science', 'Project in Theoretical Computer Science'),
(193, 'CPSC', 503.03, 'Project in Computer Graphics', 'Project in Computer Graphics'),
(194, 'CPSC', 503.04, 'Project in Information Security', 'Project in Information Security'),
(195, 'CPSC', 503.05, 'Project in Scientific Computation', 'Project in Scientific Computation'),
(196, 'CPSC', 503.06, 'Project in Software Engineering', 'Project in Software Engineering'),
(197, 'CPSC', 503.07, 'Project in Human Computer Interaction', 'Project in Human Computer Interaction'),
...
INSERT INTO `registrar` (`UID`, `Last_Login`, `Fname`, `Mname`, `Lname`) VALUES
(1, '2017-03-25 15:22:27', '', NULL, '');
...
ALTER TABLE `shopping_Cart`
  ADD UNIQUE KEY `UCID` (`UCID`,`SID`),
  ADD KEY `FK_shopping_cart_student` (`UCID`),
  ADD KEY `FK_shopping_cart_section` (`SID`);
...
--
ALTER TABLE `shopping_Cart`
  ADD CONSTRAINT `FK_shopping_cart_section` FOREIGN KEY (`SID`) REFERENCES `section` (`Sid`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_shopping_cart_student` FOREIGN KEY (`UCID`) REFERENCES `student` (`UCID`) ON DELETE SET NULL ON UPDATE CASCADE;

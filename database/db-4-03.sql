...
-- Dumping data for table test2.course: ~214 rows (approximately)
...
-- Dumping structure for table test2.degree
...
-- Dumping data for table test2.degree: ~0 rows (approximately)
...
-- Dumping structure for table test2.department
...
-- Dumping data for table test2.department: ~156 rows (approximately)
...
-- Dumping structure for table test2.enroll_course
...
-- Dumping data for table test2.enroll_course: ~0 rows (approximately)
/*!40000 ALTER TABLE `enroll_course` DISABLE KEYS */;
/*!40000 ALTER TABLE `enroll_course` ENABLE KEYS */;


-- Dumping structure for table test2.enroll_deg
...
-- Dumping data for table test2.enroll_deg: ~0 rows (approximately)
...
-- Dumping structure for table test2.instructor
...
-- Dumping data for table test2.instructor: ~167 rows (approximately)
...
-- Dumping structure for table test2.lab
...
-- Dumping data for table test2.lab: ~133 rows (approximately)
...
-- Dumping structure for table test2.lecture
...
-- Dumping data for table test2.lecture: ~70 rows (approximately)
...
-- Dumping structure for table test2.major
...
-- Dumping data for table test2.major: ~38 rows (approximately)
...
-- Dumping structure for table test2.minor
...
-- Dumping data for table test2.minor: ~0 rows (approximately)
/*!40000 ALTER TABLE `minor` DISABLE KEYS */;
/*!40000 ALTER TABLE `minor` ENABLE KEYS */;


-- Dumping structure for table test2.registrar
...
-- Dumping data for table test2.registrar: ~0 rows (approximately)
...
-- Dumping structure for table test2.restriction
...
-- Dumping data for table test2.restriction: ~0 rows (approximately)
/*!40000 ALTER TABLE `restriction` DISABLE KEYS */;
/*!40000 ALTER TABLE `restriction` ENABLE KEYS */;


-- Dumping structure for table test2.section
...
-- Dumping data for table test2.section: ~370 rows (approximately)
...
-- Dumping structure for table test2.shopping_cart
CREATE TABLE IF NOT EXISTS `shopping_cart` (
  `UCID` int(8) DEFAULT NULL,
  `SID` int(10) DEFAULT NULL,
  KEY `FK_shopping_cart_student` (`UCID`),
  KEY `FK_shopping_cart_section` (`SID`),
  CONSTRAINT `FK_shopping_cart_section` FOREIGN KEY (`SID`) REFERENCES `section` (`Sid`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `FK_shopping_cart_student` FOREIGN KEY (`UCID`) REFERENCES `student` (`UCID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Dumping data for table test2.shopping_cart: ~0 rows (approximately)
/*!40000 ALTER TABLE `shopping_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `shopping_cart` ENABLE KEYS */;


-- Dumping structure for table test2.student
...
-- Dumping data for table test2.student: ~0 rows (approximately)
...
-- Dumping structure for table test2.tutorial
...
-- Dumping data for table test2.tutorial: ~167 rows (approximately)
...
-- Dumping data for table test2.user: ~2 rows (approximately)

...
-- Dumping structure for table test.enroll_sec
CREATE TABLE IF NOT EXISTS `enroll_sec` (
  `UCID` int(8) DEFAULT NULL,
  `SID` int(10) DEFAULT NULL,
  KEY `FK_enroll_sec_student` (`UCID`),
  KEY `FK_enroll_sec_section` (`SID`),
  CONSTRAINT `FK_enroll_sec_section` FOREIGN KEY (`SID`) REFERENCES `section` (`Sid`),
  CONSTRAINT `FK_enroll_sec_student` FOREIGN KEY (`UCID`) REFERENCES `student` (`UCID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Dumping data for table test.enroll_sec: ~0 rows (approximately)
/*!40000 ALTER TABLE `enroll_sec` DISABLE KEYS */;
/*!40000 ALTER TABLE `enroll_sec` ENABLE KEYS */;
...
-- Dumping data for table test.registrar: ~1 rows (approximately)
...
-- Dumping structure for table test.shopping_cart
CREATE TABLE IF NOT EXISTS `shopping_cart` (
  `UCID` int(8) DEFAULT NULL,
  `SID` int(10) DEFAULT NULL,
  UNIQUE KEY `UCID` (`UCID`,`SID`),
...
-- Dumping data for table test.shopping_cart: ~0 rows (approximately)
...
-- Dumping data for table test.student: ~1 rows (approximately)
...
-- Dumping data for table test.tutorial: ~167 rows (approximately)
